...
```powershell
irm https://raw.githubusercontent.com/__GHOWNER__/Vans-Ai-Studio/main/installers/install.ps1 | iex
```

**macOS / Linux:**

```bash
curl -fsSL https://raw.githubusercontent.com/__GHOWNER__/Vans-Ai-Studio/main/installers/install.sh | bash
```
...
כל הקבצים בעמוד ה-[Releases](https://github.com/__GHOWNER__/Vans-Ai-Studio/releases):
...
🌐 **גרסת Web (בלי התקנה):** https://__GHOWNERLC__.github.io/Vans-Ai-Studio/
...
```bash
git clone https://github.com/__GHOWNER__/Vans-Ai-Studio.git
```
