...
- 🏢 **שתי גרסאות** — מתג בסרגל הצד בין **יצירה** (תמונות, מודלים, וידאו, מוזיקה, תלת־ממד) לבין **עבודה** (מסמכים ומצגות).
- 📄 **מסמכים** — AI כותב מאמר, דוח, מכתב, אימייל, סיכום, תוכנית עבודה, קו"ח או פרוטוקול ישיבה. אפשר לערוך כל שורה ישירות, ולייצא ל-**Word אמיתי (.docx)**, PDF, HTML או TXT.
- 📊 **מצגות** — AI בונה מצגת שלמה עם כותרות ונקודות, אופציונלית עם איור AI לכל שקופית. מצב הצגה מלא, וייצוא ל-**PowerPoint אמיתי (.pptx)** שנפתח ב-Office, Google Slides ו-LibreOffice.
